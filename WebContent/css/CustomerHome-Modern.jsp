    ...
    <div class="main-container">
        ...
        <div class="section-header">
            <div>
                ...
                <p class="section-subtitle">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt</p>
            </div>
        ...
        <div class="section-header" style="margin-top: 4rem;">
            <div>
                <h2 class="section-title">Popular in 2020</h2>
                <p class="section-subtitle">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt</p>
            </div>
            <button class="view-all-btn" onclick="window.location.href='<%=request.getContextPath()%>/viewbook'">
                View More <i class="fas fa-arrow-right"></i>
